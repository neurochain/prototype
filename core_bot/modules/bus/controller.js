...
function Controller() {
  ...
  linkEvents(COMMGR_CTRL_BACKUP_OBJECT, CTRL_HISTMGR_BACKUP_OBJECT);
  ...
  linkEvents(SRV_CTRL_SET_CONF, CTRL_BIZMGR_SET_CONF);
  linkEvents(SRV_CTRL_START, CTRL_NTKMGR_ASK_REGISTER);
  linkEvents(SRV_CTRL_START, CTRL_BIZMGR_START);
  linkEvents(SRV_CTRL_START, CTRL_CSNMGR_START);
  linkEvents(SRV_CTRL_START, CTRL_BLKMGR_LAUNCH);
}
